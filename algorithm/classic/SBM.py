...
class SBM(Algorithm):
    ...
    def process(self, G: Graph, **kwargs):
        ...
        sizes, probs = self.estimate_sbm_parameters(G, num_clusters=kwargs['num_clusters'])
    ...
    def estimate_sbm_parameters(G, num_clusters=2):
        ...
        initial_partition = [nodes[i * community_size:(i + 1) * community_size] for i in range(num_clusters)]
